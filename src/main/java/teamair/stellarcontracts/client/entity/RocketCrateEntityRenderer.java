...
public class RocketCrateEntityRenderer extends EntityRenderer<RocketCrateEntity> {
    ...
    static class Model extends BaseModel<RocketCrateEntity> {
        public Model() {
            ...
            model.setTextureOffset(0, 0).addBox(-14.0F, -13.0F, 2.0F, 12.0F, 11.0F, 12.0F, 0.0F, false);
            model.setTextureOffset(36, 0).addBox(-11.0F, -14.0F, 5.0F, 6.0F, 1.0F, 6.0F, 0.0F, false);
            model.setTextureOffset(0, 23).addBox(-14.5F, -11.0F, 1.5F, 13.0F, 1.0F, 13.0F, 0.0F, false);
            model.setTextureOffset(0, 37).addBox(-14.5F, -8.0F, 1.5F, 13.0F, 1.0F, 13.0F, 0.0F, false);
            model.setTextureOffset(0, 51).addBox(-3.6F, -14.0F, 12.4F, 2.0F, 8.0F, 2.0F, 0.0F, false);
            model.setTextureOffset(0, 0).addBox(-14.4F, -14.0F, 12.4F, 2.0F, 8.0F, 2.0F, 0.0F, false);
            model.setTextureOffset(0, 23).addBox(-14.4F, -14.0F, 1.7F, 2.0F, 8.0F, 2.0F, 0.0F, false);
            model.setTextureOffset(0, 37).addBox(-3.6F, -14.0F, 1.6F, 2.0F, 8.0F, 2.0F, 0.0F, false);
            model.setTextureOffset(48, 49).addBox(-5.0F, -6.0F, 11.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
            model.setTextureOffset(48, 7).addBox(-15.0F, -6.0F, 1.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
            model.setTextureOffset(39, 39).addBox(-5.0F, -6.0F, 1.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
            model.setTextureOffset(39, 23).addBox(-15.0F, -6.0F, 11.0F, 4.0F, 6.0F, 4.0F, 0.0F, false);
        }
    }
}
