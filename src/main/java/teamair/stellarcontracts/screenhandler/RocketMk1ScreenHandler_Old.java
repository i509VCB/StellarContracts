...
public class RocketMk1ScreenHandler_Old extends BaseScreenHandler {
	public PlayerEntity player;
	public RocketMk1Entity entity;
	public int id;

	public RocketMk1ScreenHandler_Old(int syncId, int entityId, PlayerInventory playerInventory) {
